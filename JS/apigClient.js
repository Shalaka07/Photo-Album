...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAZVY435LIRPSPSKH2',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://cors-anywhere.herokuapp.com/https://1ubsx6h64b.execute-api.us-east-1.amazonaws.com/Stage1';
